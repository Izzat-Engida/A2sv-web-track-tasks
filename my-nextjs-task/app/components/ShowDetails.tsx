        ...
        <div className="flex gap-[62px] p-[32px]">
            ...
            <div className="w-2/3 space-y-8 py-[46px]">
                    ...
                    <ul className="list-disc ml-6 space-y-2 text-[16px] text-[#25324B]">
                        <li>
                            <span className="font-semibold">
                                Young ({job.ideal_candidate.age} year old) {job.ideal_candidate.gender} social media manager
                            </span>
                        </li>
                ...
                <div>
                    ...
                    <div className="flex gap-5">
                        <FontAwesomeIcon icon={faLocationDot} height={50} width={50} color="#26A4FF" /><span className="text-[16px] leading-[1.6] font-[400] text-[#25324B]">{job.when_where}</span> 
                    </div>
                </div>
            </div>
            ...
            <div className="w-1/3 space-y-6">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {job.about.required_skills.map((req, index) => (
